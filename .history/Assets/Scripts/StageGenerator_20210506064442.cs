...
public class StageGenerator : MonoBehaviour
{
    ...
    public void SetEnemies(GameObject stageObject)
    {
        ...
        DragonController[] dragon = stageObject.GetComponentsInChildren<DragonController>();
        //敵の数を設定
        enemyCount = enemies.Length;
        int dragonCount = dragon.Length;
        ...
        foreach(DragonController d in dragon)
        {
            d.OnDestroyed.AddListener(() =>
            {
    ...
    void Update()
    {
        ...
        if (enemyCount == 0 || enemyDefeatCount > 2)
        {
